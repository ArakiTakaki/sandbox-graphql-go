...
func (ec *executionContext) field_Mutation_createTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewTodo2githubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐNewTodo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	return ec.marshalNTodo2ᚖgithubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNTodo2ᚕgithubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewTodo2githubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐNewTodo(ctx context.Context, v interface{}) (NewTodo, error) {
...
func (ec *executionContext) marshalNTodo2githubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐTodo(ctx context.Context, sel ast.SelectionSet, v Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚕgithubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐTodo(ctx context.Context, sel ast.SelectionSet, v []Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTodo2githubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐTodo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTodo2ᚖgithubᚗcomᚋArakiTakakiᚋsandboxᚑgraphqlᚑgoᚋserverᚐTodo(ctx context.Context, sel ast.SelectionSet, v *Todo) graphql.Marshaler {
	if v == nil {
